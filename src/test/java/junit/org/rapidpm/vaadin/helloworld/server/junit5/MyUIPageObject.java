...
public class MyUIPageObject extends AbstractVaadinPageObject {
  ...
  public String toString() {
    return "MyUIPageObject{" + this.getWebDriver().getClass().getSimpleName() + '}';
  }


  public MyUIPageObjectTestbenchFunctional.WithID<TextFieldElement> textField = (id) -> $(TextFieldElement.class).id(id);
  public MyUIPageObjectTestbenchFunctional.WithID<ButtonElement> btn = (id) -> $(ButtonElement.class).id(id);
